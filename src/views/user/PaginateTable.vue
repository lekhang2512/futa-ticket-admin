...
export default {
  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: this.$t('pages.user.name'), value: 'name', sortable: false },
        { text: this.$t('pages.user.phone'), value: 'phone', sortable: false },
  ...
  computed: {
    ...mapGetters('user', ['users', 'userPagination']),
